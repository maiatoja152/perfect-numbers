...
## Usage
- Efficiently search for perfect numbers using Mersenne primes and the [Lucas-Lehmer primality test](https://en.wikipedia.org/wiki/Lucas%E2%80%93Lehmer_primality_test) in a range of *p* values. Mersenne numbers are calculated using the formula *(2^p-1)*.
